...
export default function InviteAccept() {
  ...
  if (status === 'expired') return card(<>
    ...
    <div style={{ fontFamily: "'Josefin Sans', sans-serif", fontSize: 22, color: '#0B0F1A', marginBottom: 8 }}>Invite expired</div>
  ...
  if (status === 'error') return card(<>
    <div style={{ fontSize: 36, marginBottom: 12 }}>✕</div>
    <div style={{ fontFamily: "'Josefin Sans', sans-serif", fontSize: 22, color: '#0B0F1A', marginBottom: 8 }}>Can't open invite</div>
  ...
  if (status === 'accepted') return card(<>
    <div style={{ fontSize: 36, marginBottom: 12 }}>✓</div>
    <div style={{ fontFamily: "'Josefin Sans', sans-serif", fontSize: 22, color: '#0B0F1A', marginBottom: 8 }}>You're in!</div>
  ...
  return card(<>
    ...
    <div style={{ fontFamily: "'Josefin Sans', sans-serif", fontSize: 26, color: '#0B0F1A', marginBottom: 6 }}>
      {invite?.trip_title}
    </div>
